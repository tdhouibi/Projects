...

{
	...
	function insertTOC( $location=1,
        ...
        ###################################### Median Calculation##################
           function Median_value($zahlen_array = array()) {
...
function Header()
{
$this->image('actineo.jpg',144,10,50,20);
$this->SetFont("Arial","B","8");
$this->MultiCell(40, 5, utf8_decode('Reporting-Vergleich Geschäftsjahr 2014'), '', 'L', False);
}
	function Footer() {
  ...
  $this->Cell(17,4,'ACTINEO GmbH','',0,'L');
  $this->SetFont('Arial','',6);
  $this->Cell(133,4,utf8_decode(' | Wankelstr. 33 | 50996 Köln | T +49 (0) 2236 48 003 100 | F +49 (0) 2236 48 003 111'),0,1);

  $this->Cell(150,4,utf8_decode('Geschäftsführer: Verena Klumb und Olav Skowronnek | Amtsgericht Köln HRB 66509 | USt-IdNr. DE266328084'),0,2);
  $this->Cell(150,4,'HypoVereinsbank Leipzig | IBAN: DE27 8602 0086 0015 9007 41 | BIC: HYVEDEMM495',0,2);
  $this->SetTextColor(200, 87, 0);
  $this->Cell(150,4,'www.actineo.de',0,2);

...
function get_smg_gr($sg_korridor_oben,$avg_actineo,$rd)
{ 
    ...
    $abfrage= "select count(smg.k_smg) as smg_gr from
...
function get_smg_ls($sg_korridor_unten,$avg_actineo,$rd)
{ 
    ...
    $abfrage= "select count(smg.k_smg) as smg_ls from
...
where a.k_status = 'geschlossen' and k_bemerkung like '14%'
...
//    exit;
    ...
    set_values($alle_rd[$i],$jahr,$count_array,get_smg_ls(25,$smg_durchschnitt_actineo,$alle_rd[$i]),get_smg_gr(15,$smg_durchschnitt_actineo,$alle_rd[$i]),
